package ru.mirea.lavrukhin.thread;
...
import ru.mirea.lavrukhin.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: 06, НОМЕР ПО СПИСКУ: 14, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: ДОКТОР СТРЭНДЖ");
            ...
            public	void	onClick(View	v)	{
                ...
                new	Thread(new	Runnable()	{
                    public	void run()	{
                        ...
                        Log.d("ThreadProject",	String.format("Запущен	поток:	№%d / Cтудентом	группы:	%s /	Номер	по списку:	%d	",	numberThread,	"БСБО-06-21",	14));
